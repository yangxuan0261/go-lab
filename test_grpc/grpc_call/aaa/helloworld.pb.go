...
func (m *HiRequest) GetCmdId() uint32 {
	if m != nil {
		return m.CmdId
	}
	return 0
...
var fileDescriptor_17b8c58d586b62f2 = []byte{
	...
	,
}
...
type GreeterClient interface {
	...
	SayBye(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayByeClient, error)
}
...
func (c *greeterClient) SayBye(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayByeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/helloworld.Greeter/SayBye", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterSayByeClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterSayByeClient) Recv() (*HelloReply, error) {
	m := new(HelloReply)
...
type GreeterServer interface {
	...
	SayBye(Greeter_SayByeServer) error
}
...
func (*UnimplementedGreeterServer) SayBye(srv Greeter_SayByeServer) error {
...
func _Greeter_SayBye_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).SayBye(&greeterSayByeServer{stream})
}
...
func (x *greeterSayByeServer) Send(m *HelloReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterSayByeServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
